...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.BulkCreateBooksRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handlers.BulkCreateBooksRequest": {
            "type": "object"
        },
        "models.APIResponse": {
            "type": "object",
